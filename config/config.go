...
func Load() Config {
	...
	cfg.HTTPPort = cast.ToString(getOrReturnDefaultValue("HTTP_PORT", ":4040"))
	...
	cfg.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "system_market"))
